...
const styles = StyleSheet.create({
  ...
  passwordInputContainer: { flexDirection: "row",  color: "#000000", backgroundColor: "#f5f5f5", borderRadius: 10, alignItems: "center" },
  passwordInput: { flex: 1, padding: 12, fontSize: 16 , color: "#000000",},
  eyeIcon: { padding: 10 },
