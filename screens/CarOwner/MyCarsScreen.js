...
import CarCard from "../../components/Map/CarCard"
...
const MyCarsScreen = () => {
        ...
        <View style={styles.skeletonContainer}>
          {viewType === "grid" ? (
            <View style={styles.gridSkeletonContainer}>
              <LoadingSkeleton style={styles.gridSkeleton} />
              <LoadingSkeleton style={styles.gridSkeleton} />
              <LoadingSkeleton style={styles.gridSkeleton} />
              <LoadingSkeleton style={styles.gridSkeleton} />
            </View>
            ...
            <>
              <LoadingSkeleton style={styles.listSkeleton} />
              <LoadingSkeleton style={styles.listSkeleton} />
              <LoadingSkeleton style={styles.listSkeleton} />
            </>
          )}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate("AddNewCar")}>
