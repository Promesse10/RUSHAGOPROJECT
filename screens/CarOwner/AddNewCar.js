...
const AddNewCar = ({ route, navigation }) => {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
          ...
          <View style={styles.stepContent}>
            ...
            <View style={styles.topChoiceContainer}>
              <View>
                ...
                <Text style={styles.topChoiceDescription}>
                  Get premium visibility for your car listing
                </Text>
              </View>
              <Switch
      ...
      case 3:
        return (
          <View style={styles.stepContent}>
            <Text style={styles.inputLabel}>Car Location</Text>
            ...
            <View style={styles.availabilityContainer}>
              <View>
                ...
                <Text style={styles.availabilityDescription}>
                  Toggle off to hide your car from search results
                </Text>
              </View>
              <Switch
